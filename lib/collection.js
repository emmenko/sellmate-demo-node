...
exports.load = function (collectionId, req, callback) {
	var target = Config.shopUrl + '/rest/collections/' + collectionId;
	console.log(target);
...
exports.count = function (req, callback) {	
	var target = Config.shopUrl + '/rest/collections/count';	
	console.log(target);
...
exports.list = function (page, limit, req, callback) {
	...
	var target = Config.shopUrl + '/rest/collections' + '?fields=id,title,featured_image,num_of_products&limit=' + limit + '&page=' + page;
	console.log(target);
